...
// Приложение использует шаблонизатор, чтобы в файле со специальным разрешением '.mustache'
// заменить специальные участки кода на значения переменных, которые передаются  при рендеринге.
