...
http.createServer((request, response) => {// вызов метода создания http сервераlet pathname, extname, mimeType;
    ...
    if (extname === '.mp4') {
        ...
        responseHeaders['Content-Type'] = mimeType;
        responseHeaders['Accept-Ranges'] = 'bytes'; //Говорим, что отдаем диапазон с байтамиresponseHeaders['Cache-Control'] = 'no-cache'; //не кешировать результат
